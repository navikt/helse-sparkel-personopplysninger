...
import no.nav.helse.sparkel.personopplysninger.oppslag.arbeidsforhold.SikkerhetsavvikException
...
class InntektClient(private val inntektV3: InntektV3) {
    ...
    fun hentInntekter(aktørId: String, fom: YearMonth, tom: YearMonth, filter: String) =
            Try {
    ...
    private fun hentInntektListeRequest(aktørId: String, fom: YearMonth, tom: YearMonth, filter: String) =
