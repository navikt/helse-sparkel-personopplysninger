...
class ArbeidsforholdClientTest {
    ...
    fun `skal returnere feil når arbeidsforholdoppslag gir feil`() {
        ...
        val actual = arbeidsforholdClient.finnArbeidsforhold("08078422069", LocalDate.of(2018, 1, 1), LocalDate.of(2018, 12, 1))
    ...
    fun `skal returnere liste over arbeidsforhold`() {
        ...
        val arbeidsforholdClient = ArbeidsforholdClient(arbeidsforholdV3)
        val result = arbeidsforholdClient.finnArbeidsforhold("08078422069", LocalDate.of(2018, 1, 1), LocalDate.of(2018, 12, 1))
